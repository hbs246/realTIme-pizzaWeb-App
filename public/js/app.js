...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    ...
    if (dataStatus === order.status) {
      ...
      console.log(status); //     removeTime(status);
...
socket.on('updateOrder', function (data) {
  ...
  updateStatus(updateOrder); //  console.log(updateOrder);
